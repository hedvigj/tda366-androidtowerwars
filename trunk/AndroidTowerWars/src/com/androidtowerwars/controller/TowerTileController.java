...
public class TowerTileController {
	...
	public TowerTileController() {
		World.getInstance().getTowerTileListMap().put(Team.GOOD, new CopyOnWriteArrayList<TowerTile>());
		World.getInstance().getTowerTileListMap().put(Team.EVIL, new CopyOnWriteArrayList<TowerTile>());
	}	
}
